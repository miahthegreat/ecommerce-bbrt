...
const Privacy = () => {
  return (
    <motion.div
      className="prose mx-auto mt-32 dark:prose-invert lg:prose-xl"
      initial="offscreen"
    ...
    >
      <h1>Privacy Policy for Buffalo Bills Revenge Tour</h1>

      <p>
        At Buffalo Bills Revenge Tour, accessible from
        buffalobillsrevengetour.com, one of our main priorities is the privacy
        of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by Buffalo Bills Revenge Tour
        and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Buffalo Bills Revenge Tour. This policy is not
      ...
      <p>
        Buffalo Bills Revenge Tour follows a standard procedure of using log
      ...
      <p>
        Like any other website, Buffalo Bills Revenge Tour uses 'cookies'. These
      ...
      <p>
        ...
        advertising partners of Buffalo Bills Revenge Tour.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Buffalo Bills Revenge Tour,
      ...
      <p>
        Note that Buffalo Bills Revenge Tour has no access to or control over
      ...
      <p>
        Buffalo Bills Revenge Tour's Privacy Policy does not apply to other
      ...
      <p>
        Buffalo Bills Revenge Tour does not knowingly collect any Personal
